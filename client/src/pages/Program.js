		...
		<Template>
			...
			<Container fluid>
				<Row className="justify-content-center text-white care-row">
					<Col className="d-flex flex-column align-items-sm-center justify-content-sm-center align-items-lg-end justify-content-lg-end bg-danger pt-3" lg={6}>
						<div className="po-content-container w-100">
							<Heading2 className="text-yellow">After Care Program</Heading2>
							<Paragraph>
								6-9 month in house program focused on:<br />
								...
								Contact made with precious
								employers (if indicated)
							</Paragraph>

						</div>
					</Col>
					<Col className="d-flex flex-column align-items-sm-center justify-content-sm-center align-items-lg-start justify-content-lg-end p-0" lg={6}>
						<div className="po-content-container w-100">
							<img
				...
				<Row className="flex-lg-row-reverse care-row">
					<Col className="d-flex flex-column align-items-sm-center justify-content-sm-center align-items-lg-start justify-content-lg-start pt-3 po-col" lg={6}>
						<div className="po-content-container w-100">
							<Heading2 className="text-blue">Early Intervention Program</Heading2>
							<Paragraph>
								Schools and community program targeted at ages 13-21 years: <br />
					...
					<Col className="d-flex flex-column align-items-sm-center justify-content-sm-center align-items-lg-end justify-content-lg-start p-0" lg={6}>
						<div className="po-content-container w-100">
							<img
					...
					<Col className="quote-container bg-blue d-flex flex-column justify-content-center align-items-center">
						<blockquote className="blockquote po-content-container w-100">
							...
							&quot;<Heading1 className="d-inline">Strength and growth </Heading1>
								...
								<Paragraph className="lead text-white d-inline"> - Napoleon Hill</Paragraph>
							</Heading2>
						</blockquote>
					</Col>
				</Row>
